          ...
          <div className="bg-primary rounded-xl p-7 flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center gap-7 mt-3">
                ...
                <div className={`${Lastcalculated?.total_funds?.TotalFundsGrowth>=0?"bg-green":"bg-red-200"}  px-2 py-1 rounded-full text-white flex items-center justify-center  text-sm font-medium`}>
          ...
          <div className="bg-primary rounded-xl p-7 flex items-center justify-between">
            <div>
              ...
              <div className="w-[200px] h-3 bg-[#D9D7CF] rounded-full mt-5 relative">
                <div className={`w-[${parseInt(Lastcalculated?.pending_Funds?.pendingPaymentPercentage)}%] h-3 bg-green rounded-full`}></div>
              </div>
              <p className="text-sm font-medium text-gay-300 mt-5">
                <span className={`${Lastcalculated?.pending_Funds?.pendingPaymentLastPercentage>!0?"text-green":"text-red-200"} `}>{Lastcalculated?.pending_Funds?.pendingPaymentLastPercentage}%</span> from last month
              </p>
            </div>
            <h2 className="text-Dark_black font-semibold text-[34px]">{Lastcalculated?.pending_Funds?.pendingPaymentsCount}</h2>
          </div>
        </div>
      </div>
    </>
