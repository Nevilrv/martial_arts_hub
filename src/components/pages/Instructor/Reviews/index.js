          ...
          <div className="mt-8 flex flex-col gap-4">
            <div className="bg-primary_dark p-6 rounded-lg">
              <p className="text-base">
                1. Training here has been a transformative experience. I've
            ...
            <div className="bg-primary_dark p-6 rounded-lg">
              <p className="text-base">
                2. The instructors are amazing and supportive. I've learned so
                much and made great friends. The positive atmosphere and
                challenging classes have made a huge difference in my fitness
                and focus.
              </p>
              <h2 className="text-base text-black font-bold mt-1">
                - John Doe
            ...
            <div className="bg-primary_dark p-6 rounded-lg">
              <p className="text-base">
                3. I really enjoyed the class. The instructor’s teaching style
                is engaging and motivating, making complex concepts easy to
                understand.
              </p>
              <h2 className="text-base text-black font-bold mt-1">
                - Sarah Kim
